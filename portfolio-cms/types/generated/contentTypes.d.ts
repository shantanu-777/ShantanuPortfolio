...
export interface ApiAchievementAchievement extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Achievements and statistics';
...
export interface ApiCertificationCertification
  ...
  info: {
    description: 'Certifications and training programs';
...
export interface ApiContactInformationContactInformation
  ...
  attributes: {
    contactMessage: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCoreCompetencyCoreCompetency
  extends Struct.CollectionTypeSchema {
  collectionName: 'core_competencies';
  info: {
    description: 'Core skills and competencies';
    displayName: 'Core Competency';
    pluralName: 'core-competencies';
    singularName: 'core-competency';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCvSectionCvSection extends Struct.CollectionTypeSchema {
  collectionName: 'cv_sections';
  info: {
    description: 'CV section content for portfolio';
    displayName: 'CV Section';
    pluralName: 'cv-sections';
    singularName: 'cv-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cvSections: Schema.Attribute.Component<'shared.cv-section-item', true>;
    cvUrl: Schema.Attribute.String & Schema.Attribute.Required;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    previewDescription: Schema.Attribute.Text;
    previewName: Schema.Attribute.String & Schema.Attribute.Required;
    previewTitle: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quickFacts: Schema.Attribute.Component<'shared.quick-fact', true>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Curriculum Vitae'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProfessionalExperienceProfessionalExperience
  ...
  info: {
    description: 'Professional work experience and journey';
...
export interface ApiToolCategoryToolCategory
  ...
  info: {
    description: 'Tools and technologies organized by category';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::core-competency.core-competency': ApiCoreCompetencyCoreCompetency;
      'api::cv-section.cv-section': ApiCvSectionCvSection;
